...
import { deletefetchMedicalDesies, getfetchMedicalDesies } from '@/redux/features/Home/popularMedicalDesiesSlice'
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (confirm.isConfirmed) {
                await dispatch(deletefetchMedicalDesies(id));
                Swal.fire({
                    title: "Deleted!",
        ...
        <div>
            <div className='pt-10 '>
                ...
                <div className=' flex items-end px-10'>
                    <Link href={'/Deshboard/DeshboardHome/Home_Popular_Desis_Form'}>
                                    ...
                                    mediaclDesies.map((data, index) => (
                                        <tr key={data.id}>
                                            ...
                                            <td className='text-3xl text-center text-white cursor-pointer '>
                                                <Link href={`Home_Popular_Desis_List/${data.id}`}><FaEdit /></Link>
                                            </td>
                                            <td
