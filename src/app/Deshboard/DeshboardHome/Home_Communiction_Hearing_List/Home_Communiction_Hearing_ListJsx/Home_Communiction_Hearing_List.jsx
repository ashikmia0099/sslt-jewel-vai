...
import { deletefetchHearingAndHealthCare, getfetchHearingAndHealthCare } from '@/redux/features/Home/hearingAndHealthCareSlice'
...
function Home_Communiction_Hearing_List() {
    ...
    const handleDelete = async (id) => {
        ...
        if (confirm.isConfirmed) {
            try {
                await dispatch(deletefetchHearingAndHealthCare(id));
        ...
        <div>
            <div className='pt-10 '>
                ...
                <div className=' flex items-end px-10'>
                    <Link href={'/Deshboard/DeshboardHome/Home_Communiction_Hearing'}>
                ...
                <div className='px-10 '>
                    <div className="overflow-x-auto">
                        <table className="table ">
                            ...
                            <tbody>
                                {
                                    hearingAndhealthCareData.map((data, index) => (
                                        <tr key={data.id}>
                                            ...
                                            <td className='text-3xl text-center text-white cursor-pointer '>
                                                <Link href={`Home_Communiction_Hearing_List/${data.id}`}><FaEdit /></Link>
                                            </td>
                                            <td
