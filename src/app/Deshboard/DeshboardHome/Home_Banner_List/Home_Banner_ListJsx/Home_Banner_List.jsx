...
import { deleteHeroData, fetchHeroData } from '@/redux/features/Home/HeroSlice'
...
function Home_Banner_List() {
    ...
    const handleDelete = async (id) => {
        ...
        if (confirm.isConfirmed) {
            try {
                await dispatch(deleteHeroData(id));
        ...
        <div>
            <div className='pt-10 '>
                ...
                <div className=' flex items-end px-10'>
                    <Link href={'/Deshboard/DeshboardHome/Home_Banner_Form'}>
                                    ...
                                    hero_data.map((data, index) => (
                                        <tr key={data.id}>
                                            ...
                                            <td className='text-3xl text-center text-white cursor-pointer '>
                                                <Link href={`Home_Banner_List/${data.id}`}><FaEdit /></Link>
                                            </td>
                                            <td
